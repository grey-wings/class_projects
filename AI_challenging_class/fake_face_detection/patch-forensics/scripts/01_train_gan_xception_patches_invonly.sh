### celebahq-pgan inverted real pairs vs the real image ###
python train.py --gpu_ids 0 --seed 0 --loadSize 299 --fineSize 299 \
	--name gp1c-gan-invonly --save_epoch_freq 200 \
	--real_im_path dataset/faces/celebahq/inverted_real \
	--fake_im_path dataset/faces/celebahq/inverted_fake \
...
python train.py --gpu_ids 0 --seed 0 --loadSize 299 --fineSize 299 \
	--name gp1c-gan-invonly --save_epoch_freq 50 \
	--real_im_path dataset/faces/celebahq/inverted_real \
	--fake_im_path dataset/faces/celebahq/inverted_fake \
	--suffix seed{seed}_{which_model_netD}_{lr_policy}_p{patience} \
