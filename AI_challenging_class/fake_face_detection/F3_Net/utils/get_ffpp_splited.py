...
def dealLocalVideos(inPath, outPath_list, timeF=7, multiThread=False):
    # 预处理
    ...
    for video in tqdm(videos[start:]):
        ...
        img_dir = os.path.join(outPath_list[getRandomPart()], video.split('/')[-1].split('.')[0])
...
if __name__ == '__main__':
    ...
    # 处理后图片存放位置
    out_dir_list = ['/home/PointCloud/F3_Net2/dataset_ffpp/test/real',
                    '/home/PointCloud/F3_Net2/dataset_ffpp/valid/real/',
                    '/home/PointCloud/F3_Net2/dataset_ffpp/train/real/']
    dealLocalVideos(in_dir, out_dir_list, timeF=30, multiThread=True)
